...
@MainActor
public final class PlayerSpeedPanelComp: CCLBaseComp, PlayerSpeedPanelService {

    @CCLService(serviceType: PlayerSpeedService.self) private var speedService: PlayerSpeedService?
    @CCLService(serviceType: PlayerGestureService.self) private var gestureService: PlayerGestureService?
