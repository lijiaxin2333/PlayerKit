...
@MainActor
protocol ShowcaseDetailControlService: CCLCompService {
...
@MainActor
final class ShowcaseDetailControlComp: CCLBaseComp, ShowcaseDetailControlService {
    ...
    func contextName() -> String {
        (context as? CCLContext)?.name ?? "N/A"
    }
