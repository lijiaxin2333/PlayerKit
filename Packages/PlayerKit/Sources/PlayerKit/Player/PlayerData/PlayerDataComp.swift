...
/// 播放器数据组件 - 管理播放器数据
@MainActor
public final class PlayerDataComp: CCLBaseComp, PlayerDataService {
    ...
    public func updateDataModel(_ model: PlayerDataModel) {
        ...
        print("[PlayerDataComp] 数据模型已更新: \(model.title ?? "(无标题)")")
    }
