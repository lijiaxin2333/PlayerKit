...
@MainActor
public final class PlayerDebugComp: CCLBaseComp, PlayerDebugService {
    ...
    @CCLService(serviceType: PlayerQosService.self) private var qosService: PlayerQosService?
