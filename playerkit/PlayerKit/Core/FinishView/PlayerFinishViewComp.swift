...
@MainActor
public final class PlayerFinishViewComp: CCLBaseComp, PlayerFinishViewService {
    ...
    @CCLService(serviceType: PlayerPlaybackControlService.self) private var playbackControlService: PlayerPlaybackControlService?
    ...
    public func showFinishView() {
        ...
        print("[PlayerFinishViewComp] 显示结束视图")
    }
    ...
    public func hideFinishView() {
        ...
        print("[PlayerFinishViewComp] 隐藏结束视图")
    }
}
