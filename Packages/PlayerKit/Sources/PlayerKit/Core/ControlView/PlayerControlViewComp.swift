...
@MainActor
public final class PlayerControlViewComp: CCLBaseComp, PlayerControlViewService {
    ...
    public func updateControlTemplate(_ templateClass: AnyClass?) {
        print("[PlayerControlViewComp] 更新播控模板: \(String(describing: templateClass))")
    ...
    private func createDefaultControlView() {
        ...
        print("[PlayerControlViewComp] 创建默认播控视图")
    }
