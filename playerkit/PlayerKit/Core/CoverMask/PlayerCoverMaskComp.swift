...
@MainActor
public final class PlayerCoverMaskComp: CCLBaseComp, PlayerCoverMaskService {
    ...
    public func showCoverMask(_ mask: AnyObject) {
        guard let playerView = engineService?.playerView,
            ...
            print("[PlayerCoverMaskComp] 无法显示遮罩: 播放器视图不可用或 mask 不是 UIView")
            return
        }
        ...
        print("[PlayerCoverMaskComp] 显示遮罩: \(mask)")
    }
    ...
    public func hideCoverMask(_ mask: AnyObject) {
        ...
        print("[PlayerCoverMaskComp] 隐藏遮罩")
    }
    ...
    public func hideAllCoverMasks() {
        ...
        print("[PlayerCoverMaskComp] 隐藏所有遮罩，数量: \(count)")
    }
}
