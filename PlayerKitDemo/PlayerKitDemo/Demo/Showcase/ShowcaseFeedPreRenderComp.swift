...
@MainActor
protocol ShowcaseFeedPreRenderService: CCLCompService {
...
@MainActor
final class ShowcaseFeedPreRenderComp: CCLBaseComp, ShowcaseFeedPreRenderService {
    ...
    private var sceneContext: ShowcaseFeedSceneContext? {
        (context as? CCLContext)?.holder as? ShowcaseFeedSceneContext
    }
