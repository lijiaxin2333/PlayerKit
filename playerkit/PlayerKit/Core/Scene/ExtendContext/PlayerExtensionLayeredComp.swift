...
@MainActor
public final class PlayerExtensionLayeredComp: CCLBaseComp, PlayerExtensionLayeredService {

    private var _hasExtended: Bool = false
    private var isUnextending: Bool = false
    private weak var _baseContext: CCLPublicContext?
    ...
    public override func componentDidLoad(_ context: CCLContextProtocol) {
        ...
        (self.context as? CCLContext)?.bindStickyEvent(.extensionDidAddToContextSticky, value: _hasExtended)
    }

    public override func contextDidExtend(on baseContext: CCLPublicContext) {
    ...
    public override func contextWillUnextend(on baseContext: CCLPublicContext) {
    ...
    public var baseContext: CCLPublicContext? {
        _baseContext
    }
