...
@MainActor
protocol ShowcaseAutoPlayNextService: CCLCompService {
...
@MainActor
final class ShowcaseAutoPlayNextComp: CCLBaseComp, ShowcaseAutoPlayNextService {

    @CCLService(serviceType: ShowcaseFeedDataService.self) private var dataService: ShowcaseFeedDataService?
