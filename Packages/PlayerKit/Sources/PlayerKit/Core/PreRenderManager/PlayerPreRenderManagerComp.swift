...
@MainActor
public final class PlayerPreRenderManagerComp: CCLBaseComp, PlayerPreRenderManagerService {
    ...
    public func preRender(url: URL, identifier: String) {
        ...
        if let managerCtx = self.context as? CCLContext {
    ...
    public func cancelPreRender(identifier: String) {
        ...
        if let playerCtx = entry.player?.context as? CCLContext {
