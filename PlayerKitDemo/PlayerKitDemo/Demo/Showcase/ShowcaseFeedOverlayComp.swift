...
@MainActor
protocol ShowcaseFeedOverlayService: CCLCompService {
...
final class ShowcaseFeedInfoView: UIView {
    ...
    weak var overlayContext: CCLContextProtocol?
...
@MainActor
final class ShowcaseFeedOverlayComp: CCLBaseComp, ShowcaseFeedOverlayService {
