...
open class BaseListSectionViewModel: NSObject, IGListKit.ListDiffable, ListSectionViewModelProtocol {
    ...
    weak var sectionContext: ListSectionContext?
    weak var containerConfig: ListContainerConfig?
    ...
    public func isEqual(toDiffableObject object: (any IGListKit.ListDiffable)?) -> Bool {
